...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::NewProp_QuestTemplate = { "QuestTemplate", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQuestBlueprintGeneratedClass, QuestTemplate), Z_Construct_UClass_UQuest_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::NewProp_QuestTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::NewProp_QuestTemplate_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::ClassParams = {
		...
		0,
		0x009200A0u,
		METADATA_PARAMS(Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestBlueprintGeneratedClass_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_Narrative_Public_QuestBlueprintGeneratedClass_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_Narrative_Public_QuestBlueprintGeneratedClass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQuestBlueprintGeneratedClass, UQuestBlueprintGeneratedClass::StaticClass, TEXT("UQuestBlueprintGeneratedClass"), &Z_Registration_Info_UClass_UQuestBlueprintGeneratedClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestBlueprintGeneratedClass), 1722284134U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_Narrative_Public_QuestBlueprintGeneratedClass_h_547716899(TEXT("/Script/Narrative"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_Narrative_Public_QuestBlueprintGeneratedClass_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_Narrative_Public_QuestBlueprintGeneratedClass_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
