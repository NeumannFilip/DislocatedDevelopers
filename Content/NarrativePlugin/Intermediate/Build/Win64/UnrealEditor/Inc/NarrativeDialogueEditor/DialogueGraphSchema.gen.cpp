...
class UScriptStruct* FDialogueSchemaAction_NewNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DialogueSchemaAction_NewNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode, Z_Construct_UPackage__Script_NarrativeDialogueEditor(), TEXT("DialogueSchemaAction_NewNode"));
	}
...
template<> NARRATIVEDIALOGUEEDITOR_API UScriptStruct* StaticStruct<FDialogueSchemaAction_NewNode>()
{
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_NodeTemplate = { "NodeTemplate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueSchemaAction_NewNode, NodeTemplate), Z_Construct_UClass_UDialogueGraphNode_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_SpeakerInfo = { "SpeakerInfo", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueSchemaAction_NewNode, SpeakerInfo), Z_Construct_UScriptStruct_FSpeakerInfo, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_SpeakerInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::NewProp_SpeakerInfo_MetaData)) }; // 1843592173
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueSchemaAction_NewNode_Statics::Struct_MetaDataParams))
	};
...
class UScriptStruct* FDialogueSchemaAction_AddComment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DialogueSchemaAction_AddComment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDialogueSchemaAction_AddComment, Z_Construct_UPackage__Script_NarrativeDialogueEditor(), TEXT("DialogueSchemaAction_AddComment"));
	}
...
template<> NARRATIVEDIALOGUEEDITOR_API UScriptStruct* StaticStruct<FDialogueSchemaAction_AddComment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDialogueSchemaAction_AddComment_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueSchemaAction_AddComment_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueSchemaAction_AddComment_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ScriptStructInfo[] = {
		...
		{ FDialogueSchemaAction_AddComment::StaticStruct, Z_Construct_UScriptStruct_FDialogueSchemaAction_AddComment_Statics::NewStructOps, TEXT("DialogueSchemaAction_AddComment"), &Z_Registration_Info_UScriptStruct_DialogueSchemaAction_AddComment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialogueSchemaAction_AddComment), 3772262119U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueGraphSchema, UDialogueGraphSchema::StaticClass, TEXT("UDialogueGraphSchema"), &Z_Registration_Info_UClass_UDialogueGraphSchema, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueGraphSchema), 3545570405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_4183954733(TEXT("/Script/NarrativeDialogueEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueGraphSchema_h_Statics::ScriptStructInfo),
		nullptr, 0);
