...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_ParentClass = { "ParentClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueAssetFactory, ParentClass), Z_Construct_UClass_UDialogueBlueprint_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_ParentClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_ParentClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_LegacyAsset = { "LegacyAsset", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueAssetFactory, LegacyAsset), Z_Construct_UClass_UDialogueAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_LegacyAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueAssetFactory_Statics::NewProp_LegacyAsset_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDialogueAssetFactory_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UDialogueAssetFactory_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueAssetFactory_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueAssetFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueAssetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueAssetFactory, UDialogueAssetFactory::StaticClass, TEXT("UDialogueAssetFactory"), &Z_Registration_Info_UClass_UDialogueAssetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueAssetFactory), 134338684U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueAssetFactory_h_751227061(TEXT("/Script/NarrativeDialogueEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueAssetFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Private_DialogueAssetFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
