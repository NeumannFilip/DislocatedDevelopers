...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueGraph = { "DialogueGraph", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueBlueprint, DialogueGraph), Z_Construct_UClass_UEdGraph_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueGraph_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueGraph_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueTemplate = { "DialogueTemplate", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueBlueprint, DialogueTemplate), Z_Construct_UClass_UDialogue_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_DialogueTemplate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_LegacyAsset = { "LegacyAsset", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueBlueprint, LegacyAsset), Z_Construct_UClass_UDialogueAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_LegacyAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueBlueprint_Statics::NewProp_LegacyAsset_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDialogueBlueprint_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UDialogueBlueprint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueBlueprint_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Public_DialogueBlueprint_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Public_DialogueBlueprint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueBlueprint, UDialogueBlueprint::StaticClass, TEXT("UDialogueBlueprint"), &Z_Registration_Info_UClass_UDialogueBlueprint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueBlueprint), 3377997867U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Public_DialogueBlueprint_h_633326931(TEXT("/Script/NarrativeDialogueEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Public_DialogueBlueprint_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeDialogueEditor_Public_DialogueBlueprint_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
