...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQuestGraphNode_Action_Statics::Class_MetaDataParams[] = {
		...
		{ "ToolTip", "Should be called UQuestGraphNode_Branch, but the rename was making previous releases incompatible and ClassRedirects weren't woorking." },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQuestGraphNode_Action_Statics::NewProp_Branch = { "Branch", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQuestGraphNode_Action, Branch), Z_Construct_UClass_UQuestBranch_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQuestGraphNode_Action_Statics::NewProp_Branch_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestGraphNode_Action_Statics::NewProp_Branch_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQuestGraphNode_Action_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UQuestGraphNode_Action_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestGraphNode_Action_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphNode_Action_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphNode_Action_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQuestGraphNode_Action, UQuestGraphNode_Action::StaticClass, TEXT("UQuestGraphNode_Action"), &Z_Registration_Info_UClass_UQuestGraphNode_Action, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestGraphNode_Action), 4191917072U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphNode_Action_h_2656624130(TEXT("/Script/NarrativeQuestEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphNode_Action_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphNode_Action_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
