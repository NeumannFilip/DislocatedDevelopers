...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UQuestBlueprint_Statics::Class_MetaDataParams[] = {
		...
		{ "ToolTip", "Base class for a quest blueprint that can be created in editor" },
	};
#endif
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestGraph = { "QuestGraph", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQuestBlueprint, QuestGraph), Z_Construct_UClass_UEdGraph_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestGraph_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestGraph_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestTemplate = { "QuestTemplate", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UQuestBlueprint, QuestTemplate), Z_Construct_UClass_UQuest_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestBlueprint_Statics::NewProp_QuestTemplate_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQuestBlueprint_Statics::ClassParams = {
		...
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UQuestBlueprint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestBlueprint_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Public_QuestBlueprint_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Public_QuestBlueprint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQuestBlueprint, UQuestBlueprint::StaticClass, TEXT("UQuestBlueprint"), &Z_Registration_Info_UClass_UQuestBlueprint, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestBlueprint), 1888700076U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Public_QuestBlueprint_h_3528674583(TEXT("/Script/NarrativeQuestEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Public_QuestBlueprint_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Public_QuestBlueprint_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
