...
class UScriptStruct* FQuestSchemaAction_NewNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QuestSchemaAction_NewNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode, Z_Construct_UPackage__Script_NarrativeQuestEditor(), TEXT("QuestSchemaAction_NewNode"));
	}
...
template<> NARRATIVEQUESTEDITOR_API UScriptStruct* StaticStruct<FQuestSchemaAction_NewNode>()
{
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::NewProp_NodeTemplate = { "NodeTemplate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FQuestSchemaAction_NewNode, NodeTemplate), Z_Construct_UClass_UQuestGraphNode_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::NewProp_NodeTemplate_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::Struct_MetaDataParams))
	};
...
class UScriptStruct* FQuestSchemaAction_AddComment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_QuestSchemaAction_AddComment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FQuestSchemaAction_AddComment, Z_Construct_UPackage__Script_NarrativeQuestEditor(), TEXT("QuestSchemaAction_AddComment"));
	}
...
template<> NARRATIVEQUESTEDITOR_API UScriptStruct* StaticStruct<FQuestSchemaAction_AddComment>()
{
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FQuestSchemaAction_AddComment_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FQuestSchemaAction_AddComment_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FQuestSchemaAction_AddComment_Statics::Struct_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UQuestGraphSchema_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UQuestGraphSchema_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UQuestGraphSchema_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ScriptStructInfo[] = {
		{ FQuestSchemaAction_NewNode::StaticStruct, Z_Construct_UScriptStruct_FQuestSchemaAction_NewNode_Statics::NewStructOps, TEXT("QuestSchemaAction_NewNode"), &Z_Registration_Info_UScriptStruct_QuestSchemaAction_NewNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestSchemaAction_NewNode), 3788455922U) },
		{ FQuestSchemaAction_AddComment::StaticStruct, Z_Construct_UScriptStruct_FQuestSchemaAction_AddComment_Statics::NewStructOps, TEXT("QuestSchemaAction_AddComment"), &Z_Registration_Info_UScriptStruct_QuestSchemaAction_AddComment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestSchemaAction_AddComment), 3206225928U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UQuestGraphSchema, UQuestGraphSchema::StaticClass, TEXT("UQuestGraphSchema"), &Z_Registration_Info_UClass_UQuestGraphSchema, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UQuestGraphSchema), 1083975474U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_2963391284(TEXT("/Script/NarrativeQuestEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_Narrative_Source_NarrativeQuestEditor_Private_QuestGraphSchema_h_Statics::ScriptStructInfo),
		nullptr, 0);
